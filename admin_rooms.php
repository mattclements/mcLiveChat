...
<td NOWRAP height=31><input type=checkbox value=N name=user_alert_new  <?php echo $user_alert; ?> onclick=document.mine.submit() ><b><?php echo $lang['txt136']; ?></b><a href="javascript:showhelpwindow(6)">(?)</a></td>
