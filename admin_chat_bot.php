...
?><td width=30><a href=admin_chat_bot.php?channelsplit=<?php echo $channelsplit ?>><img src="images/refreshpeople.png" alt="REFRESH TABS" width=31 height=21 border=0></a></td>
    ...
    <?php } ?>  
    <?php if(substr($CSLH_Config['everythingelse'],2,1)=="Y"){ ?>    
      &nbsp;<a href="http://www.facebook.com/pages/Crafty-Syntax-Live-Help/121511414532698" target="_blank"><img src=images/fb.png width=25 height=25 border=0></a>
    <?php } ?> 
    <?php if(substr($CSLH_Config['everythingelse'],3,1)=="Y"){ ?>    
      &nbsp;<a href="http://twitter.com/craftysyntax" target="_blank"><img src=images/tw.png width=25 height=25 border=0></a>
    <?php } ?>     
